...
require "config.php";
$id = $_GET['id'];
$sql = "SELECT * FROM `reg1` WHERE `id`='$id'";
...
<div class="container">
  <form action="updateaction.php?id=<?php echo $data['id']; ?>" method="POST">
    <div class="row">
      ...
      <div class="col-75">
        <input type="text" id="fname" name="fnm" value="<?php echo $data['fnm']; ?>" >
      </div>
    </div>
    <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
        <input type="text" id="lname" name="lnm" value="<?php echo $data['lnm']; ?>">
      </div>
    </div>
    <div class="row">
      <div class="col-25">
	...
	<div class="row">
      ...
      <div class="col-75">
       <input type="radio" name="rd1" value="Male">Male
